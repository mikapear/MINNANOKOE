...
<div class="mx-auto max-w-4xl">
    ...
    <div class="mb-8 text-center">
        ...
        <p class="mt-3 text-sm text-gray-500">
            MINNANOKOEをご利用いただくにあたり、以下の利用規約をご確認ください。
        </p>
    ...
    <article class="space-y-6">
        ...
        <section class="rounded-xl border border-indigo-100 bg-white p-6 shadow-sm">
            ...
            <div class="mt-4 space-y-3 leading-7 text-gray-700">
                <p>「MINNANOKOE」（以下「本サービス」といいます。）は、乳がんを経験した方やそのご家族、ご友人・職場の方、医療関係者が、それぞれの立場から経験や想いを共有し、その声を残すためのサービスです。</p>
                <p>治療中に感じた不安や悩み、助けられた言葉、日々の工夫や生活の変化など、一人ひとりの体験には大切な意味があります。</p>
                <p>本サービスは、その時々の気持ちや経験を記録し、同じような経験をする方や周囲で支える方々にとっての支えや学びとなることを目的としています。</p>
                <p>また、患者さんの声を通じて、医療者を含むさまざまな立場の人々がお互いを理解し、支え合うきっかけとなることを目指しています。</p>
