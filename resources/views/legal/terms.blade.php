    ...
    <article class="space-y-6">
        ...
        <section class="rounded-xl border border-indigo-100 bg-white p-6 shadow-sm">
            ...
            <div class="mt-4 space-y-3 leading-7 text-gray-700">
                ...
                <p>運営者は、利用者および第三者の個人情報保護、本サービスの趣旨との整合性、読みやすさの向上その他運営上必要と判断した場合、投稿内容の一部を編集、要約または修正することがあります。</p>
                <p>運営者は、投稿内容に対してタグ付け、分類その他の整理を行うことがあります。</p>
        ...
        <section class="rounded-xl border border-indigo-100 bg-white p-6 shadow-sm">
            ...
            <div class="mt-4 space-y-3 leading-7 text-gray-700">
                <p>本サービスに掲載されるロゴ、イラスト、キャラクター、デザイン、文章、画像、プログラムその他のコンテンツ（利用者が投稿した内容を除きます。）に関する著作権その他の知的財産権は、運営者または正当な権利者に帰属します。
                ...
                <p>利用者は、運営者に対し、本サービスの運営、維持、改善、広報および利用促進に必要な範囲において、投稿内容を無償で利用、編集、要約、掲載、複製および公開する権利を許諾するものとします。</p>
