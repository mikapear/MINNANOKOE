    ...
    <article class="space-y-6">
        ...
        <section class="rounded-xl border border-indigo-100 bg-white p-6 shadow-sm">
            ...
            <div class="mt-4 space-y-3 leading-7 text-gray-700">
                ...
                <ul class="list-disc space-y-2 pl-6">
                    ...
                    <li>メールアドレス</li>
                    <li>年代算出のための生年月情報</li>
                    <li>利用者の立場（ご本人、ご家族、ご友人・職場の方、医療者等）</li>
                    <li>診断時期</li>
                    <li>治療内容</li>
                    <li>投稿内容</li>
                    <li>お問い合わせ内容</li>
        ...
        <section class="rounded-xl border border-indigo-100 bg-white p-6 shadow-sm">
            ...
            <div class="mt-4 space-y-3 leading-7 text-gray-700">
                ...
                <p>
                    また本サービスの利用状況や投稿内容について統計的に分析し、個人を特定できない形で研究、学術発表またはサービス改善に活用することがあります。
                </p>
            </div>
        </section>
        ...
        <section class="rounded-xl border border-indigo-100 bg-white p-6 shadow-sm">
            ...
            <div class="mt-4 space-y-3 leading-7 text-gray-700">
                <p>
                    本サービスでは、利用者が投稿した体験談やコメントを、内容を確認したうえで公開します。
                </p>
                <p>
                    運営者は、利用者の安全およびプライバシー保護ならびにサービスの適切な運営のため、投稿内容を確認しています。投稿内容によっては、修正をお願いする場合や、非公開とする場合、または掲載を見送る場合があります。
                </p>
                <p>
                    投稿は原則として匿名で公開されますが、利用者が投稿内容に個人を特定できる情報を記載した場合、その情報が公開される可能性があります。また、投稿内容はインターネット上で公開され、検索エンジンその他の第三者サービスを通じて閲覧される可能性があります。
                </p>
        ...
        <section class="rounded-xl border border-indigo-100 bg-white p-6 shadow-sm">
            ...
            <div class="mt-4 space-y-3 leading-7 text-gray-700">
                ...
                <p>
                    また、本サービスでは、利用状況の分析およびサービス改善のため、アクセス解析ツール（Google Analytics等）を利用する場合があります。 
                </p>
                <p>
                    これらのツールは、Cookie等を利用して利用状況に関する情報を収集することがありますが、個人を特定する情報は含まれません。
                </p>
                <p>
        ...
        <section class="rounded-xl border border-indigo-100 bg-white p-6 shadow-sm">
            ...
            <div class="mt-4 space-y-3 leading-7 text-gray-700">
                ...
                <p>
                    公開済みの投稿についても、利用者本人から削除の申し出があった場合は、内容や状況を確認のうえ、合理的な範囲で対応します。
                </p>
            </div>
        </section>
        ...
        <section class="rounded-xl border border-indigo-100 bg-white p-6 shadow-sm">
            ...
            <div class="mt-4 space-y-3 leading-7 text-gray-700">
                ...
                <div class="rounded-lg bg-indigo-50 p-4 text-sm text-indigo-900">
                    ...
                    <p class="mt-2">Survivor+事務局</p>
                    <p>メールアドレス：survivorplus.project@gmail.com</p>
                </div>
            </div>
        </section>
